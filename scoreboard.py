...
class ScoreBoard():
    ...
    def __init__(self, ai_game):
        ...
        self.font = pygame.font.SysFont(None, self.settings.font_size_sb)
    ...
    def prep_level(self):
        ...
        self.level_image = self.font.render(level_str, True, self.settings.text_color_sb,
                                                             self.settings.bg_color_sb)
    ...
    def prep_score(self):
        ...
        self.score_image = self.font.render(score_str, True, self.settings.text_color_sb,
                                                             self.settings.bg_color_sb)
    ...
    def prep_high_score(self):
        ...
        self.hight_score_image = self.font.render(hight_score_str, True, self.settings.text_color_sb,
                                                                         self.settings.bg_color_sb)
